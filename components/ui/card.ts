...
export class UbCardHeaderDirective {
  readonly class = input<string>();
  protected computedClass = computed(() => cn('flex flex-col gap-1.5 p-6', this.class()));
}
...
export class UbCardTitleDirective {
  readonly class = input<string>();
  protected computedClass = computed(() => cn('leading-none font-semibold', this.class()));
}
...
export class UbCardDescriptionDirective {
  readonly class = input<string>();
  protected computedClass = computed(() => cn('text-muted-foreground text-sm', this.class()));
}
